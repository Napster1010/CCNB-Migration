...
public class AgricultureBill6Monthly {
	@Id
	...
	public String toString() {
		return "AgricultureBill6Monthly{" + "id=" + id + ", consumerNo='" + consumerNo + '\'' + ", startBillMonth='" + startBillMonth + '\'' + ", endBillMonth='" + endBillMonth + '\'' + ", issueDate=" + issueDate + ", dueDate=" + dueDate + ", chequeDueDate=" + chequeDueDate + ", load=" + load
		        + ", unit=" + unit + ", energyCharge=" + energyCharge + ", fixedCharge=" + fixedCharge + ", fca=" + fca + ", capacitorSurcharge=" + capacitorSurcharge + ", actualBill=" + actualBill + ", subsidy=" + subsidy + ", currentBill=" + currentBill + ", securityDeposit=" + securityDeposit
		        + ", sdInterest=" + sdInterest + ", arrear=" + arrear + ", oldArrearInstallment=" + oldArrearInstallment + ", oldArrearInstallmentSubsidy=" + oldArrearInstallmentSubsidy + ", surcharge=" + surcharge + ", cumulativeSurcharge=" + cumulativeSurcharge + ", netBill=" + netBill
		        + ", surchargeArrear=" + surchargeArrear + ", createdBy='" + createdBy + '\'' + ", createdOn=" + createdOn + ", updatedBy='" + updatedBy + '\'' + ", updatedOn=" + updatedOn + '}';
	}
}
